...
{
	public class GetAllBidsOfUserForLotQueryHandlerTests
	{
		...
		[Fact]
		public async Task GetAllBidsOfUserForLotQueryHandler_WhenCalled_ReturnsAllBidsOfUserForLot()
		{
			var allBids = GetBids();
			...
			result.Should().BeOfType<GetListResponseDto<GetAllBidsOfUserForLotResponse>>();
			result.Should().NotBeNull();
			var countBids = allBids.Where(b => b.LotId == query.LotId).Count();
			countBids.Should().Be(2);
		}
